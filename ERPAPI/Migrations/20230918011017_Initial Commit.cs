...
namespace ERPAPI.Migrations
{
    ...
    public partial class InitialCommit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ColaboradoresDepartamentos",
                columns: table => new
                {
                    IDColaborador = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    IDDepartamento = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ColaboradoresDepartamentos", x => new { x.IDColaborador, x.IDDepartamento });
                });
